    ...
    return (
        <Layout>
            <div className="p-6 rounded-lg shadow-md w-full sm:w-2/4 mx-auto">
                <h1 className="text-3xl font-bold text-[#FBDB4A] mb-3">Privacy Policy </h1>
                <p className="text-white text-lg leading-relaxed mb-6">
                    Data Collection: Dr.G Bot does not collect or store personal health information. User interactions are
                    anonymized.
                </p>
